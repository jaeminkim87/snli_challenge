...
class Build_vocab():
	def __init__(self, args):
		...
		self._train_path = args.data_path + '/' + 'snli_1.0_train.txt'

	def make_vocab(self):
		tr = pd.read_csv(self._train_path, sep='\t').loc[:, ['sentence1', 'sentence2']]
		...
		embedding = nlp.embedding.create('word2vec', source='GoogleNews-vectors-negative300')
